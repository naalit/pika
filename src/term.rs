...
pub enum Pre_ {
    ...
    /// Currently just for annotated terms generated by lowering
    Typed(Pre, PreTy),
}
...
pub enum PreDef {
    ...
    /// Let with just a name
    Val(SName, PreTy, Pre),
    /// Let with a pattern other than a name
    Let(Pre, PreTy, Pre),
    Type {
        name: SName,
        is_eff: bool,
...
impl PreDef {
    ...
    pub fn name(&self) -> Option<Name> {
        match self {
            ...
            PreDef::Expr(_) | PreDef::Let(_, _, _) => None,
